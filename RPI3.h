...
//BCM2837 Broadcom processor GPIO peripheral access
...
RPI3 GPIO has 40 pins,
each pin's Function Select represented by 3 bits (datasheet page 90-92)
...
/*
GPIOSET is 7 bytes away from GPIO base address
...
/*
GPIOCLR is 10 bytes away from GPIO base address
it has 2 segments, each 4bytes long, they can be considered a single 8bytes segment
...
/*
GPIOLEV is 13 bytes away from GPIO base address
it has 2 segments, each 4bytes long, they can be considered a single 8bytes segment
